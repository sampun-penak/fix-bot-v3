...
let stiker = await sticker(null, global.API(`https://telegra.ph/file/d34b2ab2cb233c749776c.png`), global.packname, global.author)
 conn.sendFile(m.chat, stiker, 'sticker.webp', '', m, null, { fileLength: 100, contextInfo: {
    ...
    mediaUrl: sig,
    mediaType: 2,
    description: 'TheBotz-Official 𝑿 Mimim Official', 
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/sampun_penak',
    mediaType: 2, 
    description: 'www.instagram.com/sampun_penak',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/74d983dd46e8bac065b48.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/sampun_penak'
 	  }
     }
    })
}
